...
const TrainerCard = ({ searchQuery }) => {
  ...
  const trainersPerPage = 6; // Number of trainers per page
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-[5rem] mt-4">
        {displayedTrainers.map((data) => (
          <div
            ...
            className="relative max-h-[400px] min-w-[20vw] max-w-[26vw] min-h-[500px] rounded-xl overflow-hidden bg-transparent border border-orange-600 hover:border-4"
          >
